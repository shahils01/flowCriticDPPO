...
class Encoder(nn.Module):
    ...
    def __init__(self, state_dim, obs_dim, n_block, n_embd, n_head, n_agent, encode_state, num_quants=1):
    ...
    def forward(self, state, obs):
        ...
        v_loc, _ = torch.sort(self.head(rep))
...
class MultiAgentTransformer(nn.Module):
    ...
    def __init__(self, args, state_dim, obs_dim, action_dim, n_agent,
                 ...
                 action_type='Discrete', dec_actor=False, share_actor=False, num_quants=1):
        ...
        self.encoder = Encoder(state_dim, obs_dim, n_block, n_embd, n_head, n_agent, encode_state, num_quants)
